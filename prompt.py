prompt="""
{
    ...
    "tasks": [
        ...
        },
        {
            ...
            "example01": "Если накладная с оранжевыми вставками, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу. Набор цифр. Напиши их без пробелов и лишних символов."
