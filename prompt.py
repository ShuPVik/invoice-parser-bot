prompt="""
{
    ...
    "tasks": [
        ...
        },
        {
            ...
            "example01": "Если накладная с оранжевыми вставками, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу возле знака №. Набор цифр. Напиши их и только их без пробелов и лишних символов (не пиши №, нужны только цифры)."
