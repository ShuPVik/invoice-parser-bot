prompt="""
{
    ...
    "tasks": [
        ...
        },
        {
            ...
            "example01": "Если фотография сине-оранжевая, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу. Набор цифр. Не добавляй пробелы."
            "example02": "Если это обычное черно-белое изображение, то номер может быть как над штрих-кодом, так и под ним. Как в левом верхнем углу, так и в правом."
        },
        {
            "task03": "верни в ответе объект с ключами и значениями error и number, без лишних символов, например ",
            "example01": {
                "number": "АЗ-22-04",
                "error": "False"
            },
