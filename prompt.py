prompt="""
{
    ...
    "tasks": [
        ...
        },
        {
            ...
            "example01": "Если накладная сине-оранжевая, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу. Там будет знак №. Набор цифр. Напиши их без пробелов."
