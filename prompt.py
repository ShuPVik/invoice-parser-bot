prompt="""
{
    ...
    "tasks": [
        {
            "task01": {
                "task": "Определи, предоставлена ли тебе накладная. Это документ. На ней должен быть QR-код или штрих-код, лого компании, а также номер документа. Ключевые слова, что это накладная: Отправитель, получатель, плательщик.",
