prompt="""
{
    ...
    "tasks": [
        {
            "task01": {
                "task": "определи, предоставлена ли тебе фотография документа на перевозку груза (накладная), содержащая данные отправителя, получателя и номер документа",
        ...
        },
        {
            ...
            "example01": "Если документ с оранжевыми вставками, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу возле знака №. Набор цифр. Напиши их и только их без пробелов и лишних символов."
            "example02": "Если это обычный документ, то номер может быть как над штрих-кодом, так и под ним. Как в левом верхнем углу, так и в правом."
        },
        {
