prompt="""
{
    ...
    "tasks": [
        ...
        },
        {
            ...
            "example01": "Если накладная с оранжевыми вставками, с рукописным текстом, то номер накладной это то, что находится под штрих-кодом в правом верхнем углу. Там будет знак № (его не пиши). Набор цифр. Напиши их без пробелов."
